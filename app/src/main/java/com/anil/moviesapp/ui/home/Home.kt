...
import com.anil.di.util.Constants.Companion.IMAGE_URL
import com.anil.di.util.PreferencesManager
import com.anil.moviesapp.MoviesApplication
import com.anil.moviesapp.R
import com.anil.moviesapp.ui.details.DetailsActivity

@Composable
fun HomeScreenPopular(modifier: Modifier) {
...
fun MoviesLandscapeApp() {
    Surface(color = MaterialTheme.colorScheme.background) {
        Row(Modifier.fillMaxHeight()) {
            ...
            HomeScreenPopular(Modifier)
        }
    }
}

@Composable
fun MoviesPortraitApp() {
    /* Scaffold(
         //topBar = { TopBar() },
...
@Composable
fun MoviesHomeScreen(windowSize: WindowSizeClass) {
